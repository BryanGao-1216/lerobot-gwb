...
def find_pruneable_heads_and_indices(heads, n_heads, head_size, already_pruned_heads):
    ...
    for head in heads:
        head -= sum(1 if already_pruned_head < head else 0 for already_pruned_head in already_pruned_heads)
        mask[head] = 0
...
class Blip2QFormerModel(Blip2PreTrainedModel):
    ...
    def get_head_mask(self, head_mask, num_hidden_layers):
        """Compatibility implementation for Transformers 5's PreTrainedModel."""
