...
from lerobot.datasets.rlds.oxe.utils.droid_utils import droid_baseact_transform, droid_finetuning_transform
...
def rh20t_new_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "rh20t": rh20t_new_dataset_transform,
    "rl_bench": rh20t_new_dataset_transform,
}
